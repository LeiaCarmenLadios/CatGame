...
public class Pipe implements GameObject {
    ...
    public Pipe(int startX, int startY, int playerGap, int color) {
        ...
        this.pipeRect = new Rect(20 + (startX), startY + (playerGap + 100), Constants.PIPE_WIDTH + startX, Constants.SCREEN_HEIGHT);
        this.pipeRect2 = new Rect(20 + (startX ), 0, Constants.PIPE_WIDTH + startX, startY);
